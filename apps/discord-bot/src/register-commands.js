...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) =>
      o.setName('id').setRequired(true).addChoices(
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) => o.setName('action').setRequired(true).addChoices({ name: 'list', value: 'list' }, { name: 'buy', value: 'buy' }))
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) =>
      o.setName('action').setRequired(true).addChoices(
        { name: 'tea', value: 'tea' },
        { name: 'vow', value: 'vow' },
  ...
  new SlashCommandBuilder()
    ...
    .addIntegerOption((o) => o.setName('listing')),
  new SlashCommandBuilder()
    .setName('gold')
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) =>
      o.setName('action').addChoices({ name: 'list', value: 'list' }, { name: 'buy', value: 'buy' }, { name: 'sell', value: 'sell' })
    )
    .addStringOption((o) => o.setName('id'))
    .addIntegerOption((o) => o.setName('quantity')),
  new SlashCommandBuilder().setName('delve').setDescription('Enter curse spirit nest'),
  new SlashCommandBuilder().setName('grabbag').setDescription('Curse capsules')
    .addStringOption((o) =>
      o.setName('action').addChoices(
        { name: 'buy', value: 'buy' },
  ...
  new SlashCommandBuilder()
    ...
    .addUserOption((o) => o.setName('target').setRequired(true))
    .addIntegerOption((o) => o.setName('value'))
].map((c) => c.toJSON());
